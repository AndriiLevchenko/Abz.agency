       ...
       <footer >
        <div className='navbar'>
          ...
          <div className='table1'>
            <div className='table1__row'><img src='icons/mail.svg' alt='icon' /><span>work.of.future@gmail.com</span></div>
            <div className='table1__row'><img src='icons/phone.svg' alt='icon' /><span>+38 (050) 7892498</span></div>
            <div className='table1__row'><img src='icons/cellphone.svg' alt='icon' /><span>+38 (095) 5560845</span></div>
          </div>
